...
export function dijkstra(grid, startNode, endNode) {
    const visitedNodes = []; // To animate visited nodes in order to animate the process of searching.
    ...
    while (unvisitedNodes.length) {
      ...
      if (closestNode.distance === Infinity) return {visitedNodes, error:"no path found"};
  ...
  function updateUnvisitedNeighbors(node, grid) {
    ...
    for (const neighbor of unvisitedNeighbors) {
      ...
      neighbor.previous = node; // With this property we can backtrack and find the shortest path between the start and end node.
    }
  }
